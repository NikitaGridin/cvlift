...
CREATE TABLE "Analysis" (
    ...
    "userId" TEXT,
    "resumeId" TEXT,
    "analysisMode" TEXT NOT NULL DEFAULT 'vacancy',
    "targetRole" TEXT,
    "salaryMin" INTEGER,
    "salaryMax" INTEGER,
    "salaryCurrency" TEXT,
    ...
    "vacancyMatchScore" INTEGER NOT NULL,
    ...
    "keywordCoverage" JSONB,
    "resumeIdeas" JSONB,
    "improvedResumeText" TEXT NOT NULL,
...
-- CreateIndex
CREATE INDEX "WalletTransaction_analysisId_idx" ON "WalletTransaction"("analysisId");
...
-- AddForeignKey
ALTER TABLE "WalletTransaction" ADD CONSTRAINT "WalletTransaction_analysisId_fkey" FOREIGN KEY ("analysisId") REFERENCES "Analysis"("id") ON DELETE SET NULL ON UPDATE CASCADE;
