...
import { Coins, FileUp, History } from "lucide-react";
import { useI18n } from "@/components/preferences-provider";
import type { TranslationKey } from "@/lib/i18n";

const navigation = [
  { href: "/upload", labelKey: "common.upload", icon: FileUp },
...
export function AppNavigation() {
  ...
  return (
    <nav className="flex items-center gap-1 overflow-x-auto lg:flex-col lg:items-stretch lg:gap-2 lg:pt-8">
      {navigation.map((item) => {
