...
export const translations = {
  en: {
    ...
    "common.agent": "Create resume",
    "common.upload": "Analysis",
    "common.uploadResume": "Resume analysis",
    ...
    "marketing.header.upload": "Dashboard",
    ...
    "home.primarySignedIn": "Open dashboard",
    "home.primarySignedOut": "Open dashboard",
    ...
    "home.cta.google": "Open dashboard with Google",
    ...
    "agent.title": "Resume builder",
    "agent.subtitle":
      "Answer guided questions by voice or text, and CVlift will assemble a structured resume draft.",
    "agent.intro":
      "Hi. I will ask questions in order: job target, companies, then personal details. First question: where are you looking for work, what vacancy are you targeting, and what income level do you want?",
    "agent.panel.title": "Voice session",
    "agent.brief.title": "Resume draft",
    "agent.brief.text":
      "The resume builder will collect your role, experience, achievements, stack, education, projects, and links before drafting the resume.",
    "agent.voice.disclosure": "AI-generated voice",
    "agent.voice.title": "Resume builder",
    "agent.voice.mode": "Voice mode",
    "agent.voice.current": "Current question",
    "agent.voice.answer": "Your answer",
    "agent.voice.empty": "Voice answer appears here.",
    "agent.chat.title": "Conversation",
    "agent.chat.aiAgent": "Resume assistant",
    "agent.chat.you": "You",
    "agent.status.ready": "Ready",
    "agent.status.online": "Online",
    "agent.status.listening": "Listening",
    "agent.status.waiting": "Finishing phrase",
    "agent.status.thinking": "Thinking",
    "agent.status.speaking": "Speaking",
    "agent.status.voiceUnsupported":
      "Voice input is unavailable in this browser.",
    "agent.action.listen": "Start voice",
    "agent.action.stop": "Stop",
    "agent.action.sendVoice": "Send answer",
    "agent.action.openChat": "Open chat",
    "agent.action.closeChat": "Close chat",
    "agent.action.openFullscreen": "Open fullscreen",
    "agent.action.closeFullscreen": "Close fullscreen",
    "agent.action.send": "Send",
    "agent.action.speakLast": "Speak last answer",
    "agent.action.stopSpeaking": "Stop voice",
    "agent.call.listeningToYou": "Listening to you",
    "agent.call.mute": "Mute microphone",
    "agent.call.end": "End",
    "agent.call.start": "Start",
    "agent.call.pause": "Pause",
    "agent.call.speaker": "Speaker",
    "agent.input.placeholder": "Answer by voice or type here...",
    "agent.finalVoiceSummary":
      "Done. I prepared the resume and downloaded it as a text file.",
    "agent.finalDownload.title": "Resume TXT is ready",
    "agent.finalDownload.text":
      "The final resume is structured as a readable .txt file with sections, paragraphs, and bullet points.",
    "agent.finalDownload.button": "Download .txt",
    "agent.leave.title": "Leave the conversation?",
    "agent.leave.text":
      "If you leave now, the current voice session will stop and unsaved answers may be lost.",
    "agent.leave.stay": "Stay",
    "agent.leave.confirm": "Leave",
    "agent.leave.browserWarning":
      "The current voice session will stop if you leave this page.",
    "agent.error.unavailable": "The resume builder is temporarily unavailable.",
    "agent.error.voiceUnsupported":
      "Voice input is not supported in this browser.",
    "agent.error.voiceInput": "Could not read voice input.",
    "upload.title": "Analysis",
    "upload.subtitle":
      "Run a general audit or compare a resume against a specific vacancy.",
    ...
    "resume.credits.freeAvailable": "Resume analysis is currently free.",
    "resume.credits.freeCost": "CV Credits will not be spent for this upload.",
    ...
    "credits.freeLabel": "Free",
    "credits.freeMode": "Resume analysis is currently free.",
    ...
    "credits.usageTextFree":
      "Completed resume analyses do not spend credits while free mode is enabled.",
  ...
  ru: {
    ...
    "agent.subtitle":
      "Ответьте на вопросы голосом или текстом, а CVlift соберет структурированное резюме.",
    "agent.intro":
    ...
    "resume.credits.freeCost": "CV Credits не будут списаны за эту загрузку.",
    ...
    "credits.usageTextFree":
      "Пока бесплатный режим включен, завершенные анализы не списывают кредиты.",
